 ...
 * @version 1.0
 */
public class CodeGeneratorServiceTestilist extends BaseTest {
    ...
    public void testGenerate() throws Exception {
        ...
        CodeGeneratorQueryColumnDTO type = CodeGeneratorQueryColumnDTO.builder()
                .columnName("type")
                .sqlOperate(SqlOperateTypeEnum.EQUALS).build();
        List<CodeGeneratorQueryColumnDTO> queryColumnList = Lists.newArrayList(content,item,p_id,approval,type);
        CodeGeneratorDTO codeGenerator = CodeGeneratorDTO.builder()
                .author("周天颖")//class 注释作者
                .company("三格数维")//class注释公司名字
                .tableName("t_auth_rewards_penalty")//表名
                .tablePrefix("t_")//表名前缀
                .basePackage("net.lab1024.smartadmin")//包名
                .modulePackage("business.rpscore")//业务子包名
